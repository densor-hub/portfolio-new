...
const ImageContainer = ({ image }) => {
  ...
  return (
    <section className="w-fit  top-[50%] -translate-y-[50%] flex flex-col relative py-14 px-10 mx-auto justify-center items-center">
      <div
        className={`w-10  h-20 border-0 border-t-4 border-l-4  absolute left-0 top-0`}
        style={{ borderColor: currentTheme }}
      ></div>

      <img src={image} className="w-[300px] h-[350px]"></img>
